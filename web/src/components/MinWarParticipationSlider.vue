...
<template>
  <div v-if="canEdit" class="ct-slider-item">
    <div class="slider-header">
      <label class="slider-label" for="min-war-participation-slider">Min War Participation</label>
      <span class="value-display">{{ localValue }} {{ localValue === 1 ? 'War' : 'Wars' }}</span>
    </div>
    
    <div class="slider-control">
      <input
        id="min-war-participation-slider"
        type="range"
        min="0"
        max="20"
        step="1"
    ...
    <p class="slider-help">Number of regular wars a member must participate in to qualify.</p>
  </div>
</template>
