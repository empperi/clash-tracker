...
<template>
  <div v-if="canEdit" class="ct-slider-item">
    <div class="slider-header">
      <label class="slider-label" for="acceptance-percent-slider">Acceptance Percentage</label>
      <span class="value-display">{{ localValue }}%</span>
    </div>
    
    <div class="slider-control">
      <input
        id="acceptance-percent-slider"
        type="range"
        min="0"
        max="100"
        step="1"
    ...
    <p class="slider-help">Minimum attack utilization expected from rostered members.</p>
  </div>
</template>
